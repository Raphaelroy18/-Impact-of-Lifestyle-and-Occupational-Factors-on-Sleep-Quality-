...
•	Stress level, heart rate, and BMI as lifestyle indicators.
...
Occupation	Profession or job type (e.g., Nurse, Engineer, Doctor, etc.)
Sleep Duration (hours)	Average sleep per night
Quality of Sleep (scale 1–10)	Self-assessed measure of sleep quality
Stress Level (scale 1–10)	Self-assessed daily stress intensity
Physical Activity Level	Daily activity intensity
BMI Category	Body Mass Index (Normal, Overweight, Obese)
